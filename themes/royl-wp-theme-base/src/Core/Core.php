...
class Core
{
    ...
    public function __construct()
    {
        if (function_exists('add_action')) {
            ...
            add_action('admin_notices', [&$this, 'printThemeErrors'], PHP_INT_MAX-1);

            // Require plugins
            add_action('tgmpa_register', [&$this, 'registerRequiredPlugins']);

            // Setup wp theme features
            add_action('after_setup_theme', [&$this, 'registerThemeFeatures'], PHP_INT_MAX-1);
            add_action('after_setup_theme', [&$this, 'registerImageSizes'], PHP_INT_MAX-1);
            add_action('after_setup_theme', [&$this, 'registerNavMenus'], PHP_INT_MAX-1);
            add_action('after_setup_theme', [&$this, 'loadTextDomain'], PHP_INT_MAX-1);
            add_action('widgets_init', [&$this, 'registerSidebars'], PHP_INT_MAX-1);
        }
    }
